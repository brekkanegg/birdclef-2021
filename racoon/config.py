...
#     "--background_datadir",
#     type=str,
#     default="/data2/minki/kaggle/ramdisk/background_noise",
# )
...
class CFG:
    ...
    # Data #
    ######################
    train_datadir = Path("/data2/minki/kaggle/ramdisk//train_short_audio")
    train_csv = "/data2/minki/kaggle/ramdisk/train_metadata.csv"
    train_soundscape = "/data2/minki/kaggle/ramdisk/train_soundscape_labels.csv"
    background_datadir = "/data2/minki/kaggle/ramdisk/background_32"
    ...
    ######################
    loader_params = {
        "train": {"batch_size": 128, "num_workers": 4, "shuffle": True},
        "valid": {"batch_size": 128, "num_workers": 4, "shuffle": False},
    }
    ...
    split_params = {"n_splits": 5, "shuffle": True, "random_state": 52}
